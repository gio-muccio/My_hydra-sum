# script di configurazione per l'addestramento del modello hydrasum con bart multi_heads
# Le probabilità associate al gate ora sono fissate manualmente
# quindi si riprende la strategia di inferenza n° 3 (Miscelazione utilizzando G specificato manualmente)
